    ...
    return <div className="home-page">
        <section id="hero" className="d-flex flex-column justify-content-center align-items-center">
            <div className="hero-container" data-aos="fade-in">
                <h1>Alex Smith</h1>
                <p>I'm <span className="typed" data-typed-items="Designer, Developer, Freelancer, Photographer"></span>
                </p>
            </div>
        </section>
        <main id="main">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4" data-aos="fade-right">
                            <img src="https://github.com/JYang496/portfolio/blob/main/public/img/profile-img.jpg?raw=true" className="img-fluid" alt=""/>
                        </div>
